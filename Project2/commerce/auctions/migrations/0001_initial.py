    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='auctions.auctioncategory')),
            ],
        ),
        migrations.CreateModel(
            name='Listing',
            fields=[
                ...
                ('status', models.CharField(choices=[('OP', 'Open'), ('CA', 'Canceled'), ('CL', 'Closed')], default='OP', max_length=2)),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='auctions.auctioncategory')),
                ('current_bidder', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='leading_bid_listings', to=settings.AUTH_USER_MODEL)),
                ...
                ('watching_users', models.ManyToManyField(blank=True, null=True, related_name='watchlist', to=settings.AUTH_USER_MODEL)),
